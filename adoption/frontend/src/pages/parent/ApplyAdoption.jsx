...
function ApplyAdoption() {
  ...
  const handleApply = () => {
    ...
    // Update child status to IN_APPLICATION
    const updatedChildren = childrenData.map(c => 
      c.id === child.id ? { ...c, status: "IN_APPLICATION" } : c
    );
    ...
    alert("Adoption application submitted successfully! Staff will review your application.");
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-md-8">
                    ...
                    <div className="mb-3">
                      <span className="badge bg-info me-2">Age: {child.age}</span>
                ...
                <div className="alert alert-info">
                  ...
                  <ol className="mb-0">
                    ...
                    <li>You'll receive a message to submit documents</li>
                    <li>Admin will verify your documents</li>
                    <li>Final approval and adoption process begins</li>
                  </ol>
                </div>
